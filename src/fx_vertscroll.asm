fx_vertscroll_init SUBROUTINE
	...
	SET_POINTER fxv_screen_ptr0, fx_vertscroll_test2
	SET_POINTER fxv_screen_ptr1, fx_vertscroll_test2+30
	SET_POINTER fxv_screen_ptr2, fx_vertscroll_test2+60
	SET_POINTER fxv_screen_ptr3, fx_vertscroll_test2+90
	jmp RTSBank
...
fx_vertscroll_test2:
; graphics/glafouk/2018-10-17_21/40x30-FreeWomen-A.png
	dc.b $ff, $33, $d5, $95, $55, $b5, $ff, $ff, $00, $ff, $fe, $fd, $fb, $fa, $f6
	dc.b $f6, $ee, $de, $df, $de, $e8, $f0, $f0, $e0, $e0, $e0, $c4, $cc, $8c, $9c
	dc.b $ff, $de, $df, $9f, $5e, $3f, $ff, $ff, $00, $ff, $0f, $f7, $1b, $eb, $4d
	dc.b $ed, $ae, $ef, $5f, $07, $42, $01, $41, $00, $40, $00, $44, $04, $44, $06
	dc.b $ff, $6e, $ae, $2e, $ae, $73, $ff, $ff, $00, $ff, $ff, $ff, $ff, $ff, $ff
	dc.b $ff, $ff, $7f, $7f, $7f, $fe, $fd, $fb, $fb, $fb, $f6, $f6, $f6, $7b, $7b
	dc.b $ff, $f8, $fd, $fd, $fd, $3d, $ff, $ff, $00, $ff, $ff, $ff, $e0, $c0, $9f
	dc.b $95, $9f, $9b, $df, $8e, $40, $ce, $ce, $80, $55, $aa, $55, $aa, $55, $2a
	dc.b $ff, $ad, $aa, $89, $ab, $ac, $ff, $ff, $00, $ff, $ff, $ff, $ff, $7f, $3f
	dc.b $3f, $3f, $3f, $7f, $3f, $4f, $77, $7b, $3b, $5b, $ad, $4d, $ad, $5b, $9b
